...
<head>
    ...
    <link href="{{asset('assets/admin/themes/explorer/theme.css')}}" media="all" rel="stylesheet" type="text/css"/>
...
<script src="{{asset('assets/admin/plugins/forms/select2/select2.js')}}"></script>
